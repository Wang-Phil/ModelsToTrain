...
if __name__ == '__main__':
    ...
    model = torch.load('/data/wangweicheng/ModelsToTrains/checkpoints/ConvNext_tiny_dual_attention_224*448/best91.584.pth', map_location='cpu')
    ...
    if args.image_path:
        ...
        image_url = './test/dislocation.jpg'
    ...
    img = cv2.resize(img, (224, 448), interpolation=cv2.INTER_AREA)
