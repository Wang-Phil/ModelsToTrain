...
# StarNet + BiomedCLIP 文本编码器训练脚本
# 使用 StarNet 作为图像编码器，BiomedCLIP 的文本编码器进行训练
...
# 输出目录
OUTPUT_DIR="output/starnet_biomedclip"
...
# StarNet 模型选择（可以选择 starnet_s1, starnet_s2, starnet_s3, starnet_s4 等）
IMAGE_ENCODER="starnet_s1"
...
print_info "=========================================="
print_info "StarNet + BiomedCLIP 训练配置"
print_info "=========================================="
print_info "数据目录: $DATA_DIR"
print_info "输出目录: $OUTPUT_DIR"
print_info "图像编码器: $IMAGE_ENCODER"
