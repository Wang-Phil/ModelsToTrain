...
def _lr_scheduler_super_init(scheduler_self, optimizer, last_epoch, verbose=False):
    """PyTorch 2.2+ removed ``verbose`` from _LRScheduler.__init__."""
    params = inspect.signature(_LRScheduler.__init__).parameters
    if "verbose" in params:
        _LRScheduler.__init__(scheduler_self, optimizer, last_epoch, verbose)
    else:
        _LRScheduler.__init__(scheduler_self, optimizer, last_epoch)
...
class _BaseWarmupScheduler(_LRScheduler):
    ...
    def __init__(
        ...
        _lr_scheduler_super_init(self, optimizer, last_epoch, verbose)
