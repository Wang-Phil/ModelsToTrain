#!/usr/bin/env python3
"""
Export Table 1 (表一) summary and per-class metrics to Excel.

Usage (project root):
  python evaluation_results/excel_aligned/export_table1_excel.py

Reads:
  table1_final_package/TABLE1_SUMMARY.csv
  table1_final_package/TABLE1_PER_CLASS.csv
...
PKG = HERE / "table1_final_package"
SUMMARY_CSV = PKG / "TABLE1_SUMMARY.csv"
PER_CLASS_CSV = PKG / "TABLE1_PER_CLASS.csv"
OUTPUT_XLSX = PKG / "TABLE1_RESULTS.xlsx"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export Table 1 metrics to Excel.")
    parser.add_argument(
        "-o",
        "--output",
        type=Path,
