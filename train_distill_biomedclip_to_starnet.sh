...
# 知识蒸馏训练脚本
# 使用 BiomedCLIP 作为教师模型，蒸馏到 ResNet50（学生模型）
...
# 输出目录
OUTPUT_DIR="output/distill_biomedclip_to_resnet50_focal_loss"
...
# 学生模型图像编码器（StarNet，可选：starnet_s1, starnet_s2, starnet_s3, starnet_s4, starnet_s050, starnet_s100, starnet_s150）
STUDENT_IMAGE_ENCODER="starnet_s1"
...
print_info "学生模型图像编码器: $STUDENT_IMAGE_ENCODER"
